use contract::media::{
    IMediaSharingDispatcher, IMediaSharingDispatcherTrait, IMediaSharingSafeDispatcher,
...
fn test_safe_empty_hash_validation() {
    ...
    match result {
        ...
        Result::Err(panic_data) => assert(
            *panic_data.at(0) == 'Media hash cannot be empty', *panic_data.at(0),
        ),
    }
}
...
fn test_safe_empty_type_validation() {
    ...
    let result = media_sharing_safe_dispatcher
        .share_media(recipient, "QmT78zSuBmuS4z925WZfrqQ1qHaJ56DQaTfyMUF7F8ff5o", "");

    match result {
        Result::Ok(_) => core::panic_with_felt252('Should have panicked'),
        Result::Err(panic_data) => assert(
            *panic_data.at(0) == 'Media type cannot be empty', *panic_data.at(0),
        ),
    }
}
...
fn test_get_media_out_of_bounds() {
    ...
    media_sharing_dispatcher
        .share_media(recipient, "QmT78zSuBmuS4z925WZfrqQ1qHaJ56DQaTfyMUF7F8ff5o", "image/jpeg");
